...
//fwrite($file_stream, $xmlheader); // writting XML
...
$reset = unlink($GLOBALS['fileJSON']); // Delete the file to rewrite it immediately after
if ($reset) {
    echo "File.json has been refresh.<br>";
}else{
    echo "File.json didn't get refresh.<br>";
}
...
//fclose($file_stream); // writting XML
